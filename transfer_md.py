...
HEADER_IMG_LIST = ["post-sample-image.jpg", "post-bg-digital-native.jpg", "post-bg-kuaidi.jpg", "post-bg-miui6.jpg",
                   "post-bg-universe.jpg", "post-bg-ios9-web.jpg", "post-bg-cook.jpg", "post-bg-miui-ux.jpg",
                   "post-bg-re-vs-ng2.jpg", "post-bg-rwd.jpg", "post-bg-YesOrNo.jpg", "post-bg-android.jpg",
                   "post-bg-coffee.jpeg", "post-bg-debug.png", "post-bg-e2e-ux.jpg", "post-bg-js-version.jpg",
                   "post-bg-hacker.jpg", "post-bg-ios10.jpg", "post-bg-ioses.jpg", "post-bg-desk.jpg",
                   "post-bg-github-cup.jpg", "post-bg-iWatch.jpg", "post-bg-mma-6.jpg", "post-bg-mma-4.jpg",
                   "post-bg-alibaba.jpg", "post-bg-mma-5.jpg", "post-bg-mma-1.jpg", "home-bg-geek.jpg",
                   "post-bg-swift2.jpg", "post-bg-mma-0.png", "post-bg-unix-linux.jpg", "post-bg-mma-2.jpg",
                   "post-bg-swift.jpg", "post-bg-keybord.jpg", "post-bg-os-metro.jpg", "post-bg-BJJ.jpg",
                   "post-bg-map.jpg", "post-bg-2015.jpg"]

logging.basicConfig(
        level=logging.DEBUG,
        format='%(asctime)s %(name)s %(filename)s[line:%(lineno)d] %(funcName)s %(levelname)s %(message)s',
        handlers=[logging.handlers.RotatingFileHandler("run_debug.log", maxBytes=1024 * 1024 * 10, backupCount=5,
                                                       encoding="utf-8")]
)
...
class XmlToMd(object):
    ...
    def start_work(self):
        ...
        time.time() - self.start_time, self.xml_post_total, self.md_sucess_count, self.md_faild_count))
    ...
    def get_md_head_and_file_pname(self, desc):
        ...
        md_head = MD_HEAD.format(title=file_name, subtitle="", date=pub_date, author=AUTHOR,
                                 header_img="%s/%s" % ("img", random.choice(HEADER_IMG_LIST)))
